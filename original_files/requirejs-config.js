...
var config = {
    map: {
        '*': {
            "Shippit_Shipping/js/view/checkout/shipping/shippit" :
                  "Acidgreen_ShippitShipping/js/view/checkout/shipping/shippit"
        }
    }
};
require.config(config);
...
var config = {
    config: {
        mixins: {
            'mage/menu': {
                'Webqem_ClickAndCollect/js/lib/mage/menu-mixin': true
            },
            'Magento_Checkout/js/action/set-shipping-information': {
               'Webqem_ClickAndCollect/js/action/set-shipping-information-mixin': true
            },
            'Magento_Checkout/js/view/shipping': {
              'Webqem_ClickAndCollect/js/view/shipping-mixin': true
            },
        }
    }
};
